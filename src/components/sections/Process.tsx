      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-4 relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="w-14 h-14 rounded-full bg-surface-gray flex items-center justify-center mb-6 text-text-stone font-mono text-sm tracking-widest transition-transform duration-500 group-hover:bg-accent-gold group-hover:text-white group-hover:scale-110 shadow-sm border border-white">
                0{index + 1}
              </div>
              <h3 className="text-xl font-serif text-text-stone mb-3">
                {step.title}
              </h3>
