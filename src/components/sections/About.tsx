      ...
      <div className="container mx-auto px-4 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-24 items-start">
          ...
          >
            ...
            <div className="w-12 h-[1px] bg-accent-gold mb-8 md:mb-0" />
          </motion.div>
          ...
          >
            <p className="text-xl md:text-2xl text-text-stone font-serif leading-relaxed mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-text-stone/70 font-sans font-light leading-loose max-w-2xl">
